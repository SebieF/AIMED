...
class PEFeatureExtractor(object):
    ...
    def __init__(self, feature_version=1):
        self.features = [
            ByteHistogram(),
...
class PEFeatureReader(object):
    ''' Load features from vectorized .dat files. '''

    def read_vectorized_features(self, data_dir, subset=None, feature_version=1):
        """
